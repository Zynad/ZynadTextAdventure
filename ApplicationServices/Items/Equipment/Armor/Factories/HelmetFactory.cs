...
public class HelmetFactory : IHelmetFactory
{
    public HelmetEntity CreateNewHelmet()
    {
        while (true)
        {
            var helmet = new HelmetEntity
            {
                Id = Guid.NewGuid(),
                ...
                PhysicalDefense = ParseHelper.AskForInt("How much physical defense should it provide? "),
                MagicResistance = ParseHelper.AskForInt("How much magic resistance should it provide? "),
